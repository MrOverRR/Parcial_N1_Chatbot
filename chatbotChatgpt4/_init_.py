...
def webhook_whatsapp():
    ...
    if request.method == "GET":
        ...
        if request.args.get('hub.verify_token') == "ChatBotOver":
...
def enviar(telefonoRecibe,respuesta):
  ...
  token='EAAU9Oijbmx8BO5i0iYlWLqviaBZAzVopRl4UEkEVh0XmBb0mJYAjZBQVgqzkr7FL3L6QQZAkDDZBu5ep24ExFgrW2FyT0yb2skSqLMeDGskHp6PWOFwx0ZC0BZC5yhZATUMmQm7gZCpOvO3mX9AB5doH8VsJN7wYEQf9bLLowiV70Qy0iNBQGffDnX9GnmfObLyCXzm3hbvX0VPywM9RIgZDZD'
  #IDENTIFICADOR DE NÚMERO DE TELÉFONO
  idNumeroTeléfono='132056699988237'
